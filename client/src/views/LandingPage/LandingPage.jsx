      ...
      <div className="flex justify-around items-center bg-gradient-to-b from-Medium__Champagne h-screen ">
        <div className="flex flex-col items-center">
          ...
          <Link to="/home" className="m-5 ">
            <button class="transition duration-500 ease-in-out px-4 py-2 transform hover:-translate-y-1 hover:scale-110 rounded-full text-white  bg-Viridian__Green font-bold hover:bg-Blue__Shappire ">
              Entrar
            </button>
          </Link>
        </div>
