        ...
        <>
            {
                open ?
                                                    ...
                                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                        ...
                                                        <div className="mt-2">
                                                            <p className="text-sm text-gray-500">
                                                                Esta seguro que desea borrar el report?
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    :
                    <button onClick={() => setOpen(true)}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="Red">
