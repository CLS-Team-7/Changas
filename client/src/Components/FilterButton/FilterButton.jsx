        ...
        <div id="Filter">
            <Disclosure as="nav" className="bg-gray-800 pb-4">
                <select name="filterBy" onChange={(e) => {
                    ...
                    className=" block w-52 text-white py-1 px-1 border-none border-gray-300 bg-transparent rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 mx-auto ">
