...
function Reviews() {
    ...
    <div>
        {/* <div className="flex justify-center mt-10">
            <div className="w-4/5 h-5/6 p-4 m-0 grid grid-cols-3 grid-rows-4 gap-2"> */}
                <div class="ml-6">
                    <p class="flex items-baseline">
                        <span class="text-gray-600 font-bold">Usuario Changas</span>
                        <span class="ml-2 text-green-600 text-xs">Cuenta verificada</span>
                    </p>
                    <div class="flex items-center mt-4 text-gray-600">
                        <div class="flex items-center">
                            <span class="text-sm">Calidad del Servicio</span>
                    ...
                    <div class="mt-3">
                        <span class="font-bold">Comentario - Review</span>
                    ...
                    <div class="flex items-center justify-between mt-4 text-sm text-gray-600 fill-current">
                        ...
                        <div class="flex items-center">
                            <span>Esta review fue de ayuda?</span>
