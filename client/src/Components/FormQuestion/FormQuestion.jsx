...
export default function AddFormQuestion(props) {
  // falta chequear tambien que el mismo usuario no se haga preguntas a si mismo, ternario en el boton enviar
  // const { user } = useAuth0();
                ...
                <div className="flex flex-col items-center py-6 space-y-3 w-11/12 md:w-9/12">
                  <div className="grid grid-cols-1">
                    <p className=" m-2 md:text-sm text-xs text-gray-100 text-light font-semibold text-center">
                      El dueño de la publicación será notificado de tu pregunta
                      y la misma se verá en el detalle de la publicación.
                    </p>
                    <p className=" m-2 md:text-sm text-xs text-gray-100 text-light font-semibold">
                      Por favor, leé atentamente la publicación antes de
                      preguntar algo que quizás ya fue respondido allí.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 w-11/12 md:w-9/12">
                    <label className="uppercase md:text-sm text-xs text-gray-100 text-light font-semibold">
                      - Publicación -
                    </label>
                    <input
                      name="post_id"
                      ...
                      className="text-center text-gray-100 py-2 px-3 rounded-lg border-2 border-yellow-400 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                    />
                  </div>
                </div>
