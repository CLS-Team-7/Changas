                ...
                <div className="flex flex-col items-center py-6 space-y-3">
                  <div className="grid grid-cols-1">
                    ...
                    <p className=" m-2 md:text-sm text-xs text-gray-900 text-light font-semibold">
                      Por favor, indicá precisamente cuál es el problema que encontraste con este anuncio para que podamos tratarlo
                    </p>
                    <p className=" m-2 md:text-sm text-xs text-gray-900 text-light font-semibold">
                  ...
                  <div className="grid grid-cols-1">
                    <label className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Publicación reportada</label>
