                  ...
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    {/* Profile dropdown */}
                    {
                      isAuthenticated === true
                                ...
                                >
                                  <div className="mt-3 px-2 space-y-1">
                                    <div className="flex flex-row justify-start items-center place-content-center">
                                      ...
                                      <Link to="/myproftest" className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-300">Mi Perfil</Link>
                                    </div>
                                    <div className="flex flex-row justify-start items-center place-content-center">
                                      <div class="text-black">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div className="flex flex-row justify-start items-center place-content-center">
                                      ...
                                      <button onClick={() => logout()} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-300">Desconectarse</button>
                                    </div>
                                  </div>
                                </Menu.Items>
                              </Transition>
                        ...
                        : <button onClick={() => loginWithRedirect()} className="bg-red-600 hover:bg-red-700 text-white text-sm px-4 py-2  border rounded-full">Entrar/Registrar</button>
                    }
                  </div>
                </div>
                  ...
                  <div className="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <div className="mt-3 px-2 space-y-1">
                      <div className="flex flex-row items-center place-content-center">
                        ...
                        <Link to="/myproftest" className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Mi Perfil</Link>
                      </div>
                      <div className="flex flex-row items-center place-content-center">
                        <div class="text-white">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div className="flex flex-row  items-center place-content-center">
                        ...
                        <button onClick={() => logout()} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Desconectarse</button>
                      </div>
                    </div>
                  </div> :
                  <button onClick={() => loginWithRedirect()} className="bg-red-600 hover:bg-red-700 text-white text-sm px-4 py-2  border rounded-full">Entrar/Registrar</button>
