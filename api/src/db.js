...
Question.hasOne(Answer, { foreignKey: 'question_idd' }); // una pregunta puede tener una respuesta
Answer.belongsTo(Question, { foreignKey: 'question_idd' }); // una respuesta puede tener una pregunta
